...
class BagTiles:
    ...
    def add_to_bag(self, tile, quantity):
        if len(self.bag) + quantity > 103:
            raise Exception103("no se pueden agregar mas fichas.")
    ...
    def initialize_bag(self):
        ...
        letter_quantity = {
            "A": 12, "B": 2, "C": 5, "D": 5, "E": 12, "F": 1, "G": 2, "H": 3, "I": 6, "J": 1, "L": 6, "M": 2,
            "N": 5, "Ñ": 1, "O": 9, "P": 2, "Q": 1, "R": 7, "S": 6, "T": 4, "U": 5, "V": 1, "X": 1, "Y": 1,
            "Z": 1,"#": 1 ,"@":1
        }
    ...
    def take(self, count):
        if len(self.bag) < count:
            raise Exception0("intentando tomar mas fichas de las disponibles")
        tiles = []
